...
class FileUploadNormalizerTest extends TestCase
{
    ...
    public static function normalizeProvider(): iterable
    {
        ...
        yield 'Single file path' => [
            [
                'upload_field' => __DIR__.'/Fixtures/file/name.jpg',
            ],
            [
                'upload_field' => [[
                    'name' => 'name.jpg',
                    'type' => 'image/jpeg',
                    'tmp_name' => Path::makeAbsolute('Fixtures/file/name.jpg', __DIR__),
                    'error' => 0,
                    'size' => 333,
                    'uploaded' => true,
                    'uuid' => null,
        ...
        yield 'Array of it all' => [
            [
                ...
                'upload_field_path' => __DIR__.'/Fixtures/file/name.jpg',
                'upload_multiple' => [
                    [
                        'name' => 'name.jpg',
                        'type' => 'image/jpeg',
                    ...
                    __DIR__.'/Fixtures/file/name.jpg',
                ],
            ],
            [
                'upload_field_already_correct' => [[
