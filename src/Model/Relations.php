...
class Relations
{
    ...
    public function addRelationCallbacks($strTable)
    {
        ...
        foreach ($GLOBALS['TL_DCA'][$strTable]['fields'] as $strField => $arrField) {
            ...
            $GLOBALS['TL_DCA'][$strTable]['fields'][$strField]['load_callback'][] = ['Codefog\HasteBundle\Model\Relations', 'getRelatedRecords'];
            $GLOBALS['TL_DCA'][$strTable]['fields'][$strField]['save_callback'][] = ['Codefog\HasteBundle\Model\Relations', 'updateRelatedRecords'];
        ...
        if ($blnCallbacks) {
            $GLOBALS['TL_DCA'][$strTable]['config']['ondelete_callback'][] = ['Codefog\HasteBundle\Model\Relations', 'deleteRelatedRecords'];
            $GLOBALS['TL_DCA'][$strTable]['config']['oncopy_callback'][] = ['Codefog\HasteBundle\Model\Relations', 'copyRelatedRecords'];
        }

        $GLOBALS['TL_DCA'][$strTable]['config']['ondelete_callback'][] = ['Codefog\HasteBundle\Model\Relations', 'cleanRelatedRecords'];

        // Add filter callbacks
        if (!empty(static::$arrFilterableFields) && 'BE' === TL_MODE) {
            $GLOBALS['TL_DCA'][$strTable]['config']['onload_callback'][] = ['Codefog\HasteBundle\Model\Relations', 'filterByRelations'];
            if (isset($GLOBALS['TL_DCA'][$strTable]['list']['sorting']['panelLayout'])){
                ...
                $GLOBALS['TL_DCA'][$strTable]['list']['sorting']['panel_callback']['haste_filter'] = ['Codefog\HasteBundle\Model\Relations', 'addRelationFilters'];
            }
        }

        if (!empty(static::$arrSearchableFields) && 'BE' === TL_MODE) {
            $GLOBALS['TL_DCA'][$strTable]['config']['onload_callback'][] = ['Codefog\HasteBundle\Model\Relations', 'filterBySearch'];
            if (isset($GLOBALS['TL_DCA'][$strTable]['list']['sorting']['panelLayout'])){
                ...
                $GLOBALS['TL_DCA'][$strTable]['list']['sorting']['panel_callback']['haste_search'] = ['Codefog\HasteBundle\Model\Relations', 'addRelationSearch'];
            }
        }
    }
