...
namespace Codefog\HasteBundle\Image;
...
class Image
{
     ...
     *
     *  - \Codefog\HasteBundle\Image\Image::SORT_NAME_ASC (sort by name, ascending)
     *  - \Codefog\HasteBundle\Image\Image::SORT_NAME_DESC (sort by name, descending)
     *  - \Codefog\HasteBundle\Image\Image::SORT_DATE_ASC (sort by date, ascending)
     *  - \Codefog\HasteBundle\Image\Image::SORT_DATE_DESC (sort by date, descending)
     *  - \Codefog\HasteBundle\Image\Image::SORT_CUSTOM | needs the orderSRC options key)
     *  - \Codefog\HasteBundle\Image\Image::SORT_RANDOM (sort randomly)
     *
