...
class DateRangeFilter
{
    ...
    public function addCallbacks($strTable)
    {
        ...
        if (!empty($this->arrFieldsToFilter)) {
            ...
            $GLOBALS['TL_DCA'][$strTable]['list']['sorting']['panel_callback']['haste_dateRangeFilter'] = array('Codefog\HasteBundle\Dca\DateRangeFilter', 'addFiltersToPanel');
            $GLOBALS['TL_DCA'][$strTable]['config']['onload_callback'][] = array('Codefog\HasteBundle\Dca\DateRangeFilter', 'filterRecords');
        }
    }
