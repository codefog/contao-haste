...
namespace Codefog\HasteBundle\Number;
...
class Number
{
     ...
     *
     * @param \Codefog\HasteBundle\Number\Number $objToAdd
     *
     * @return \Codefog\HasteBundle\Number\Number
     */
    public function add(\Codefog\HasteBundle\Number\Number $objToAdd)
    {
     ...
     *
     * @param \Codefog\HasteBundle\Number\Number $objToSubstract
     *
     * @return \Codefog\HasteBundle\Number\Number
     */
    public function subtract(\Codefog\HasteBundle\Number\Number $objToSubstract)
    {
     ...
     *
     * @param \Codefog\HasteBundle\Number\Number $objToMultiplyWith
     *
     * @return \Codefog\HasteBundle\Number\Number
     */
    public function multiply(\Codefog\HasteBundle\Number\Number $objToMultiplyWith)
    {
     ...
     *
     * @param \Codefog\HasteBundle\Number\Number $objToDivideBy
     *
     * @return \Codefog\HasteBundle\Number\Number
     */
    public function divide(\Codefog\HasteBundle\Number\Number $objToDivideBy)
    {
     ...
     *
     * @param \Codefog\HasteBundle\Number\Number
     *
     * @return bool
     */
    public function equals(\Codefog\HasteBundle\Number\Number $objToCompare)
    {
     ...
     * @return bool
     */
    public function greaterThan(\Codefog\HasteBundle\Number\Number $objToCompare)
    {
        return $this->getAmount() > $objToCompare->getAmount();
    }
     ...
     * @return bool
     */
    public function lessThan(\Codefog\HasteBundle\Number\Number $objToCompare)
    {
        return $this->getAmount() < $objToCompare->getAmount();
    }
